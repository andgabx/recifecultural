...
Funcionalidade: Aplicação de Cupom de Desconto Dinâmico
  ...
  Cenário: Sucesso ao aplicar cupom válido
    Quando o espectador com CPF "11122233344" tenta aplicar o cupom "CULTURA20" em um ingresso de "TEATRO" no valor de 150,0 reais
    Então o sistema aplica o desconto
    E o valor final da compra deve ser 120,0 reais

  Cenário: Falha ao aplicar cupom em pedido abaixo do valor mínimo
    Quando o espectador com CPF "11122233344" tenta aplicar o cupom "CULTURA20" em um ingresso de "TEATRO" no valor de 80,0 reais
  ...
  Cenário: Falha ao aplicar cupom de outra categoria
    Quando o espectador com CPF "11122233344" tenta aplicar o cupom "CULTURA20" em um ingresso de "SHOW" no valor de 150,0 reais
  ...
  Cenário: Falha por limite global de usos esgotado (Escassez)
    ...
    Quando o espectador com CPF "99988877766" tenta aplicar o cupom "CULTURA20" em um ingresso de "TEATRO" no valor de 150,0 reais
  ...
  Cenário: Falha ao usar cupom com data de validade expirada (Time Travel)
    Quando o espectador com CPF "11122233344" tenta aplicar o cupom "CULTURA20" em um ingresso de "TEATRO" no valor de 150,0 reais na data "01/01/2027"
  ...
  Cenário: Integração - Serviço aplica cupom com desconto de valor fixo
    Quando o espectador com CPF "99988877766" compra um ingresso da categoria "TEATRO" com valor base de 150,0 reais usando o cupom "FIXO50"
    Então o sistema valida o desconto com sucesso
    E o ingresso deve ser salvo no banco de dados com o valor final pago de 100,0 reais
