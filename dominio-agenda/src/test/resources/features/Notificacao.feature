Feature: Gerenciamento de Notificações
  ...
  Scenario: Marcar notificação direta como não lida
    Given que o usuário "123e4567-e89b-12d3-a456-426614174011" possui uma notificação direta lida com a mensagem "Atenção ao prazo"
