...
@Repository
class EventoRepositorioImpl implements IEventoRepositorio, EventoRepositorioAplicacao {

    private final EventoJpaRepository jpa;
    private final JpaMapeador mapeador;

    EventoRepositorioImpl(EventoJpaRepository jpa, JpaMapeador mapeador) {
        this.jpa = jpa;
