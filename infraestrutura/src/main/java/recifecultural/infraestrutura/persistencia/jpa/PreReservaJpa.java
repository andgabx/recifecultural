...
@Repository
class PreReservaRepositorioImpl implements IPreReservaRepositorio {

    private final PreReservaJpaRepository jpa;
    private final JpaMapeador mapeador;

    PreReservaRepositorioImpl(PreReservaJpaRepository jpa, JpaMapeador mapeador) {
        this.jpa = jpa;
